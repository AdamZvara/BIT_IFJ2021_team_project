...
#define ERROR_SEMANTIC_ASSIGN 4 // Semantic error during assignment (type uncompatibility)
#define ERROR_SEMANTIC_PARAMS 5 // Semantic error (wrong arguments, argument types, return code)
#define ERROR_SEMANTIC_TYPE   6 // Semantic error - aritmetic uncompatibility etc.
